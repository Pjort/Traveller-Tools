...
**Physical appearance:** Describe the mark's appearance, including any distinguishing features, clothing, or accessories. Mention any cybernetic enhancements, tattoos, or other notable characteristics. Should be possible to use for a prompting a image of the character. \n
**Description:** A detailed description of the mark. Provide a comprehensive background on their criminal history, motivations, and the specific events that led to this bounty. Include information on their skills, preferred tactics, and any known weaknesses. Mention any relevant connections to criminal organizations, political entities, or other influential groups. Describe their typical behavior patterns, known hideouts, and any recurring associates. If applicable, detail any previous attempts to apprehend them and why they failed. Include any other pertinent information that could aid the bounty hunter in their pursuit, such as the mark's psychological profile, technological capabilities, or rumored plans. \n
