...
const assignments: Assignment[] = [
	...
	new Assignment(3, new DiceCheck(5, "INT"), new DiceCheck(7, "INT"), "Corporate", "You work for a corporation, spying on rival organisations.", [
		new Rank(0, "", ""),
		new Rank(1, "Agent", "Deception 1"),
		new Rank(2, "Field Agent", "Investigate 1"),
...
const musterOutTable: MusterOutRecord[] = [
	new MusterOutRecord(1, 1000, [new Item(1, "Scientific Equipment")]),
	new MusterOutRecord(2, 2000, [new Reward(1, "INT +1")]),
	new MusterOutRecord(3, 5000, [new Item(1, "Ship Share")]),
	new MusterOutRecord(4, 7500, [new Item(1, "Weapon")]),
	new MusterOutRecord(5, 10000, [new Item(1, "Cybernetic Implant")]),
	new MusterOutRecord(6, 25000, [new Reward(1, "SOC +1"), new Item(2, "Cybernetic Implant")]),
	new MusterOutRecord(7, 50000, [new Item(1, "TAS Membership")]),
];

export const Agent: Career = new Career(1, "Agent", new DiceCheck(6, "INT"), assignments, trainingTables, eventsTable, mishapTable, musterOutTable);
